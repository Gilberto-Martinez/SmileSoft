...
def enviar_correo():
    ...
    emailMsg ="Esta es un prueba de envio de correo de SmileSoft."
    mimeMessage = MIMEMultipart()
    mimeMessage["to"] = "martinez.canhete.a@gmail.com"
    mimeMessage["subject"] = "Mensaje de Smilesoft de nuevo"  #titulo
